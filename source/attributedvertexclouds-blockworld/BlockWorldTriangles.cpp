...
{
    const auto vertexShaderSource = textFromFile("data/shaders/blockworld-triangles/standard.vert");
...
const std::vector<gl::GLuint> & BlockWorldTriangles::programs() const
{
    return m_programs;
}
